 ...
 *
 */
therapistSchema.methods.verifyPassword = function (password) {
   ...
   *
   */
  therapistSchema.methods.getPasswordHash = async function (password) {
   ...
   */
  therapistSchema.pre("save", async function save(next) {
    try {
